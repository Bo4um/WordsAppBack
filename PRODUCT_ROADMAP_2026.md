...
| **P3** | **ADHD-Friendly Mode** (нано-уроки 2-5 мин) | Инклюзивность, лояльная аудитория | Средняя | 2 спринта | ✅ **DONE** | +20% ADHD user retention |
| **P3** | **Corporate Dashboard** (B2B) | Стабильные долгосрочные контракты | Высокая | 4 спринта | ✅ **DONE** | 5+ B2B contracts ($50K ARR) |
| **P3** | **In-App Contextual Nudges** | Увеличение LTV через персонализированные пуши | Низкая | 1 спринт | ✅ **DONE** | +15% DAU, +10% session duration |
